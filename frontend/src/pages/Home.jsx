    ...
    <div className="bg-[#212529] text-yellow-300 overflow-x-hidden">
      ...
      >
        <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
          <motion.div variants={fadeInUp}>
            <h2 className="text-4xl font-bold text-[#FBBF24] mb-6">About Samsasali</h2>
            <p className="leading-relaxed text-gray-300 text-lg">
              Based in Kenya, Samsasali is more than just a honey brand — we are passionate beekeepers, educators, and suppliers.
              From raw and processed honey to hive leasing, bee relocation, and premium harvesting gear, we serve with purpose and purity.
            </p>
          </motion.div>
          <motion.div variants={fadeInUp}>
            <img
      ...
      >
        <div className="max-w-6xl mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold text-[#FBBF24] mb-14">Our Bestsellers</h2>
          <div className="grid md:grid-cols-3 gap-10">
            {[product1, product2, product3].map((img, i) => (
              ...
              >
                ...
                />
                <h3 className="text-xl font-semibold text-[#FBBF24]">Honey Product</h3>
                <p className="text-gray-300 mt-2">Pure & natural — straight from our farms.</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      >
        <div className="max-w-6xl mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold text-[#FBBF24] mb-14">What We Offer</h2>
          <div className="grid md:grid-cols-3 gap-10 text-left">
            {[{ img: hive, title: "Hive Sales & Rentals", desc: "Buy or lease beehives, tailored to your environment." },
              { img: relocation, title: "Bee Relocation", desc: "Safe, expert relocation of wild hives from your home or farm." },
              { img: beeSuit, title: "Harvesting Gear", desc: "We stock suits, smokers, and tools for beginner & pro beekeepers." }
            ].map((service, i) => (
              <motion.div
                key={i}
                variants={fadeInUp}
              ...
              >
                ...
                />
                <h3 className="text-xl font-bold text-[#FBBF24] mb-2">{service.title}</h3>
      ...
      >
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="mt-6 font-bold text-[#FBBF24]">— Sarah M., Nakuru</p>
        </div>
...
>
  <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
    ...
    {/* Left - Text */}
    <motion.div className="space-y-6" initial={{ x: -50, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} transition={{ duration: 1 }}>
      <h2 className="text-4xl md:text-5xl font-extrabold leading-tight">
        Partner with Nature — Choose Samsasali
      </h2>
      <p className="text-lg text-yellow-200 leading-relaxed">
        We’re more than just honey producers. From eco-friendly beekeeping to high-quality gear and relocation services — we’re your trusted partner in every step of the beekeeping journey.
      </p>
      <motion.a
        href="/contact"
        whileHover={{ scale: 1.05 }}
