...
//                 className="bg-[#333333] bg-gradient-to-r from-yellow-400 via-orange-500 to-yellow-600 rounded-2xl p-6 shadow-lg hover:shadow-[#FBBF24]/70 border border-[#2c2c2c] transition"
//               >
//                 <img
//                   src={img}
//                   alt="product"
...
//                 className="bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 rounded-2xl p-6 shadow-md border border-[#2c2c2c] hover:shadow-[#FBBF24]/50 transition duration-300"
//               >
//                 <img
//                   src={service.img}
//                   alt={service.title}
          ...
          <div className="grid md:grid-cols-3 gap-10">
            {[product1, product2, product3].map((img, i) => (
              <motion.div
                ...
                whileHover={{ scale: 1.03 }}
                className="
                  bg-[#333333] bg-gradient-to-r from-yellow-400 via-orange-500 to-yellow-600
                  rounded-2xl p-6 shadow-lg
                  border border-[#2c2c2c]
                  transition

                  hover:shadow-[0_0_20px_rgba(245,187,0,0.7)]   /* desktop hover glow */
                  focus:shadow-[0_0_20px_rgba(245,187,0,0.7)]   /* mobile tap / focus glow */
                  active:shadow-[0_0_20px_rgba(245,187,0,0.7)]  /* tap hold glow */

                  focus:outline-none                         /* hide default outline */
                "
              >
                <img
                  src={img}
